...
class MembershipService
{
    ...
    {
        $this->em = $em;
        $this->registration_duration = $parameterBag->get('registration_duration');
        $this->registration_every_civil_year = $parameterBag->get('registration_every_civil_year');
        $this->cycle_type = $parameterBag->get('cycle_type');
    }
