...
class ShiftReminderCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $shiftRepository = $em->getRepository('App\Entity\Shift');
        $qb = $shiftRepository
        ...
        $dynamicContent = $em->getRepository('App\Entity\DynamicContent')->findOneByCode("SHIFT_REMINDER_EMAIL")->getContent();
