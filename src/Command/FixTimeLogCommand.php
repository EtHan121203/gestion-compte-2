...
class FixTimeLogCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $members = $em->getRepository('App\Entity\Membership')->findAll();
        ...
        foreach ($members as $member) {
            if ($member->getFirstShiftDate()) {
                ...
                $shifts = $em->getRepository('App\Entity\Shift')->findShiftsForMembership($member, $previous_cycle_start, $current_cycle_end);
