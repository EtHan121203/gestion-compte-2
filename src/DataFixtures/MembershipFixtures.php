...
class MembershipFixtures extends Fixture implements OrderedFixtureInterface
{
    /**
     * @throws Exception
     */
    public function load(ObjectManager $manager): void
    {
        ...
        for ($i = 1; $i <= $membershipCount; $i++) {
            ...
            if ($i == $roleGoesToId["WITHDRAWN"]) {
                ...
                $membership->setWithdrawnBy($this->getReference('admin_' . $rand_admin_id, User::class));
            } else {
            ...
            // set beneficiary
            $beneficiary = $this->getReference('beneficiary_' . $i, Beneficiary::class);
