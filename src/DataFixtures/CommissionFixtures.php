...
class CommissionFixtures extends Fixture implements OrderedFixtureInterface
{
    /**
     * @throws Exception
     */
    public function load(ObjectManager $manager): void
    {
        ...
        for ($i = 0; $i < $commissionsCount; $i++) {
            ...
            // if beneficiaries have been set
            if ($this->hasReference('beneficiary_1', Beneficiary::class)) {
                ...
                $beneficiary_owner = $this->getReference('beneficiary_' . $ownerId, Beneficiary::class);
                ...
                if ($i == 0) {
                    foreach ((array)$roleGoesToId["IN_FIRST_COMMISSION"] as $j) {
                        $beneficiary = $this->getReference('beneficiary_' . $j, Beneficiary::class);
