...
class UserVoter extends Voter
{
    ...
    private $checkIps;
    private $allowedIpsString;


    public function __construct(
        AccessDecisionManagerInterface $decisionManager,
        RequestStack $requestStack,
        #[Autowire(param: 'enable_place_local_ip_address_check')]
        bool $checkIps,
        #[Autowire(param: 'place_local_ip_address')]
    ...
    private function isLocationOk()
    {
        ...
        $ips = explode(',', $this->allowedIpsString);
        return (!$this->checkIps) or (isset($ip) and in_array($ip, $ips));
    }
}